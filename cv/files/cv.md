...
Goiânia, Goiás, Brazil | [github.com/gszr](https://github.com/gszr) | [linkedin.com/in/gszr](https://www.linkedin.com/in/gszr) | [gsz@acm.org](mailto:gsz@acm.org)

_Software engineer with 10+ years of experience building foundational API infrastructure. Staff Software Engineer at JetStream Security, building AI governance, observability, and security infrastructure for LLMs, MCP, and agents. Previously spent nearly nine years at Kong across Kong Gateway and Kong Enterprise, most recently building AI-agent tooling (Context Mesh)._

## Experience

### Staff Software Engineer - JetStream Security (Jun 2026-Present)

- Building infrastructure for governance, observability, and security of enterprise AI traffic across LLMs, MCP, and agents.

### Senior Software Engineer - Kong Inc. (Jul 2017-May 2026)
...
- **Evaluation and validation of application programming interface requests and responses for microservices applications** - US 12,645,512, issued Jun 2, 2026
- **Configuration hash comparison** - US 11,996,982, issued May 4, 2024
...
- Professional Member, Association for Computing Machinery (since Dec 2011)
